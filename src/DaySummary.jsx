  ...
  render() {
    return (
      <tr className="day-summary">
        ...
        <Typography variant="h6" color="primary">Hora Início</Typography>
        <TimeInput changeNotify={this.notifyDayStart} default="13:00" />
        {/* <TimeInput changeNotify={this.notifyLunchStart} default="12:00" /> */}
        {/* <TimeInput changeNotify={this.notifyLunchEnd} default="12:30" /> */}
        <Typography variant="h6" color="primary">Hora Término</Typography>
        <TimeInput changeNotify={this.notifyDayEnd} default="18:00" />
