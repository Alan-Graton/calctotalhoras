...
// import timeStrToMins from "./TimeUtil";
...
class TimeInput extends React.Component {
  constructor(props) {
    ...
    this.props.changeNotify(TimeUtil.timeStrToMins(this.props.default));
  }
  ...
  onInputHandle = (ev) => {
    ...
    this.props.changeNotify(TimeUtil.timeStrToMins(formattedVal));
  };
